...
class SoccerRewards(Rewards):
    ...
    # r_cv
    # NOTE: Robot-specific implementation provided by subclasses
    def _reward_dribbling_robot_ball_vel(self):
        raise NotImplementedError("Subclass must implement _reward_dribbling_robot_ball_vel")

    # encourage robot near ball
    # r_cp
    # NOTE: Robot-specific implementation provided by subclasses
    def _reward_dribbling_robot_ball_pos(self):
        raise NotImplementedError("Subclass must implement _reward_dribbling_robot_ball_pos") 
